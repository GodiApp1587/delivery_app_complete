...
class BaseUrls {
  ...
  BaseUrls({
    ...
    required this.storeCoverPhotoUrl,
    required this.deliveryManImageUrl,
    required this.chatImageUrl,
    required this.campaignImageUrl,
    required this.moduleImageUrl,
    required this.orderAttachmentUrl,
    required this.parcelCategoryImageUrl,
  });
...
class OrderStatus {
  ...
  OrderStatus({required this.accepted});
