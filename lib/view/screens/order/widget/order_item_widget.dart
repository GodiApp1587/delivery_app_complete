      ...
      Row(children: [
        ClipRRect(
          ...
          child: CustomImage(
            ...
            fit: BoxFit.cover,
            image:
                '${order.itemCampaignId != null ? Get.find<SplashController>().configModel.baseUrls.campaignImageUrl : Get.find<SplashController>().configModel.baseUrls.itemImageUrl}/${orderDetails.itemDetails.image}',
          ),
        ),
        ...
        Expanded(
          child:
            ...
            Row(children: [
              ...
              ((Get.find<SplashController>().getModule(order.moduleType).unit &&
